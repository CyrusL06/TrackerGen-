...
export default function LoginPage() {
  return (
    <main className="relative overflow-hidden bg-[color:var(--brand-bg)]">
      ...
      />
      <div className="pointer-events-none absolute left-1/2 top-16 h-28 w-[22rem] -translate-x-1/2 rounded-full bg-[color:var(--brand-accent)]/6 blur-3xl" />
      ...
      <div className="relative mx-auto flex min-h-[calc(100vh-11rem)] w-full max-w-[31rem] items-center justify-center px-4 py-10 sm:py-14">
        <section className="delight-rise w-full border border-[color:var(--brand-border)] bg-[color:var(--brand-surface)] p-5 shadow-[0_0_0_1px_rgba(0,0,0,0.04)] sm:p-6">
          <div className="mb-5 flex items-center justify-between border-b border-[color:var(--brand-border)] pb-4">
            <div>
            ...
            <div
              className={`border border-[color:var(--brand-border)] px-3 py-2 text-[0.64rem] uppercase tracking-[0.18em] text-[color:var(--brand-text)] ${FONTS.mono}`}
            >
              01
            </div>
          </div>
