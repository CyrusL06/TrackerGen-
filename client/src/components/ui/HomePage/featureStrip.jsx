...
export default function FeatureStrip() {
  return (
    <section id="product" className="overflow-hidden border-y border-[rgba(255,255,255,0.05)] py-4" style={{ background: "var(--bg-page)" }}>
      <div className="flex flex-wrap items-center justify-center gap-x-8 gap-y-2 px-4 md:gap-x-12 md:px-10">
        {features.map((label) => (
          <div key={label} className={`inline-flex items-center gap-2 text-caption font-medium text-[oklch(0.52_0.025_260)] ${FONTS.body}`}>
