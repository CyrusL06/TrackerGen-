  ...
  return (
    <section id="access" className="relative overflow-hidden border-t border-[rgba(255,255,255,0.05)] py-20 md:py-28">
      ...
      <div className={`${LAYOUT.content} relative text-center`}>
        ...
        <h2 className={`mb-4 text-[clamp(2.2rem,7vw,4rem)] font-semibold leading-[1.1] tracking-[-0.02em] text-white ${FONTS.display}`}>
          Your money deserves
          <br />
          <span className="text-[#2779a7]">a clear view.</span>
        </h2>

        <p className={`mx-auto mb-10 max-w-md text-[1rem] leading-relaxed text-[#6b7280] md:text-[1.05rem] ${FONTS.body}`}>
        ...
        <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
          ...
          <a
            href="/signup"
            className="inline-flex items-center gap-2 rounded-lg border border-[rgba(255,255,255,0.15)] px-8 py-3.5 text-[0.95rem] font-medium text-[#9ca3af] no-underline transition-all duration-200 hover:border-[rgba(255,255,255,0.3)] hover:text-white"
          >
            Create Account
          </a>
        </div>

        <div className="mt-10 flex flex-wrap items-center justify-center gap-8 text-[0.82rem] text-[#6b7280]">
